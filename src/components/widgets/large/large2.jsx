...
const data = {
    ...
    columns: [
        ...
        {id: 'date', numeric: false, label: 'Transaction Date',},
        {id: 'amt', numeric: true, label: 'Amount',},
        {id: 'status', numeric: false, label: 'Status',},
    ],
    rows: [
        {id: 1, name: "Jane Doe", date: "2021-09-29", amt: "$1000.00", status: "Pending"},
        {id: 2, name: "John Doe", date: "2021-09-29", amt: "$1000.00", status: "Pending"},
        {id: 3, name: "Jonny Doe", date: "2021-09-29", amt: "$1000.00", status: "Pending"},
        {id: 4, name: "Jennifer Doe", date: "2021-09-29", amt: "$1000.00", status: "Pending"},
    ]
}
